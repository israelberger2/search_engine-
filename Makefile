...
src/reg_algo_links_maintenance.o src/search_engine.o  src/factory_searcher.o src/text_client.o  src/communicator.o \
src/regular_sorter.o src/border_manager.o src/acceptor.o src/net_client.o src/exist_words_search.o src/publisher.o \
src/updater.o src/unexist_words_search.o src/exist_and_unexist_search.o src/threads.o src/configuration.o \
...
includes/mysql_links_data.hpp includes/connector.hpp includes/mysql_domain_data.hpp includes/mysql_graph_data.hpp  
